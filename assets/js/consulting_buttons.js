...
function thingsToKnow() {
  ...
  data += "<li>I love working outside the bureaucracy of a large company - the independence is a good fit for me. However, it's obviously difficult to chart a career progression outside a defined system, so again, you need to be fairly self-directed to be an hourly consultant.</li>";
  ...
  data += "<li>Managing my own travel is fantastic. Having my own rental car and not having to coordinate with anyone else is fantastic. I didn't realize how much I'd appreciate these things until I started consulting.</li>";
  ...
  data += "<li>Ask the consulting firm what they're billing for you versus what your hourly rate is. It likely won't give you negotiating ground, but it's informative about the values of the company and their transparency.</li>";
