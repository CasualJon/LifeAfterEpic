...
var ventures = [
  { name: "BlueTree Network",
    ...
    acquired: true,
    parent: "Providence St. Joseph Health",
  },
  { name: "Vonlay",
  ...
  { name: "Consultapotamus",
    ...
    facebook: null,
    about: "Feedback enables organizations, firms, and contractors to take action on information in addition to intuition: transparency for customers, talent management analytics for firms, marketplace distinction for contractors.",
    category: orgType.SERVICES,
    acquired: false,
    parent: null,
  },
  { name: "Venddy",
    website: "https://venddy.com/",
    logo: "../assets/img/ventures/venddy.jpg",
    twitter: "https://twitter.com/venddyllc",
    linkedin: "https://www.linkedin.com/company/venddyllc/",
    facebook: "https://www.facebook.com/venddyllc",
    about: "Venddy is an online, provider-driven community for health systems to connect with world-class vendor partners.",
    category: orgType.SERVICES,
    acquired: false,
    parent: null,
  },
